...
`,e.jsx(n.p,{children:`The following sections help you quickly set up and execute the pipeline on your REST API. If you're looking for more in-depth information about how to use
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"(Optional): a Python virtual environment manager of your preference (e.g. conda, venv)"}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["Qdrant vector database (",e.jsx(n.a,{href:"https://qdrant.tech/documentation/",children:"Docs"}),")",`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"(Optional): Docker to spin up a local container"}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["LLM model provider (e.g. a ",e.jsx(n.a,{href:"https://www.gaianet.ai/chat",children:"Public GaiaNet node"})," or ",e.jsx(n.a,{href:"https://docs.gaianet.ai/node-guide/quick-start",children:"spin up your own"}),")",`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["An Embeddings model (e.g. ",e.jsx(n.a,{href:"https://huggingface.co/gaianet/Nomic-embed-text-v1.5-Embedding-GGUF/tree/main?show_file_info=nomic-embed-text-v1.5.f16.gguf",children:"Nomic-embed-text-v1.5"}),")"]}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.div,{"data-vocs-steps":"true",children:[e.jsxs(n.div,{"data-depth":"3",children:[e.jsxs(n.h3,{id:"clone-this-repository",children:["Clone this repository",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#clone-this-repository",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),e.jsx(n.p,{children:"Git clone or download this repository to your local machine."}),e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:e.jsx(n.code,{children:e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"git"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" clone"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" https://github.com/raid-guild/gaianet-rag-api-pipeline.git"})]})})})]}),e.jsxs(n.div,{"data-depth":"3",children:[e.jsxs(n.h3,{id:"install-the-pipeline-cli",children:["Install the Pipeline CLI",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#install-the-pipeline-cli",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),e.jsxs(n.p,{children:["It is recommended to activate your ",e.jsx(n.a,{href:"https://python-poetry.org/docs/basic-usage/#using-your-virtual-environment",children:"own virtual environment"}),`.
Then, navigate to the directory where this repository was cloned/download and execute the following command to install the `,e.jsx(n.code,{children:"rag-api-pipeline"})," CLI:"]}),e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:e.jsxs(n.code,{children:[e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:"cd"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" gaianet-rag-api-pipeline"})]}),`
`,e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"pip"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" install"}),e.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" -e"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" ."})]})]})})]}),e.jsxs(n.div,{"data-depth":"3",children:[e.jsxs(n.h3,{id:"setup-the-pipeline-configuration",children:["Setup the Pipeline Configuration",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#setup-the-pipeline-configuration",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),e.jsxs(n.p,{children:[`Run the following command to start the pipeline setup wizard. You can use the default configuration settings or customize it for your specific needs.
Check the `,e.jsx(n.a,{href:"/cli-reference",children:"CLI Reference"})," page for more details:"]}),e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:e.jsx(n.code,{children:e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"rag-api-pipeline"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" setup"})]})})})]})]}),`
`,e.jsxs(n.h2,{id:"define-your-api-pipeline-manifest",children:["Define your API Pipeline manifest",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#define-your-api-pipeline-manifest",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.p,{children:[`Now it's time to define the pipeline manifest for the REST API you're looking to extract data from. Check how to define an API pipeline manifest in
...
`,e.jsx(n.a,{href:"/apis",children:"API Examples"}),"."]}),`
...
`,e.jsxs(n.p,{children:["Now you're ready to use the ",e.jsx(n.code,{children:"rag-api-pipeline run"}),` CLI commands to execute different tasks of the RAG pipeline, from extracting data from an API source to generating vector embeddings
and a database snapshot. If you need more details about the parameters available on each command you can execute:`]}),`
`,e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0","data-title":"Terminal","data-lang":"bash",children:e.jsx(n.code,{children:e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"rag-api-pipeline"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" run"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"comman"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"d"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"}),e.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})}),`
...
`,e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"rag-api-pipeline"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" run"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" all"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"API_MANIFEST_FIL"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"E"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"OPENAPI_SPEC_FIL"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"E"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:" [--full-refresh]"})]}),`
...
`,e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"rag-api-pipeline"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" run"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" from-normalized"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"API_MANIFEST_FIL"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"E"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"}),e.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --normalized-data-file"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"jsonl-fil"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"e"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"})]}),`
...
`,e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"rag-api-pipeline"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" run"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" from-chunked"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"API_MANIFEST_FIL"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"E"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"}),e.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --chunked-data-file"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" <"}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"jsonl-fil"}),e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"e"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:">"})]})]})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"OPENAPI_SPEC_FILE"}),": API OpenAPI YAML spec file (mandatory)"]}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"from_chunked"}),": executes the RAG data pipeline using an already chunked dataset in JSONL format. You can specify the following arguments to the command:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"API_MANIFEST_FILE"}),": API pipeline manifest file (mandatory)"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--llm-provider [ollama|openai]"}),": backend embeddings model provider. default: openai-like backend (e.g. gaia rag-api-server)"]}),`
...
is specified for the `,e.jsx(n.code,{children:"run-all"})," command, the cache will be cleared and API data will be extracted from scratch."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"{baseDir}/{api_name}_stream_{x}_preprocessed.jsonl"}),": data streams from each API endpoint are preprocessed and stored in JSONL format"]}),`
