import{u as s,j as e}from"./index-7KzzTMju.js";const a={title:"Working with Other API Sources 🔌",description:"undefined"};function t(n){const i={a:"a",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.header,{children:e.jsxs(i.h1,{id:"working-with-other-api-sources-",children:["Working with Other API Sources 🔌",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#working-with-other-api-sources-",children:e.jsx(i.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(i.ul,{children:[`
`,e.jsx(i.li,{children:"Use help from LLMs to create OpenAPI schemas"}),`
...
`]}),`
`]}),`
`,e.jsxs(i.h3,{id:"3-test-and-deploy",children:["3. Test and Deploy",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#3-test-and-deploy",children:e.jsx(i.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(i.ul,{children:[`
`,e.jsx(i.li,{children:"Test each endpoint thoroughly"}),`
...
`]}),`
`,e.jsxs(i.p,{children:["Do checkout this guide on ",e.jsx(i.a,{href:"https://docs.bump.sh/guides/openapi/specification/v3.1/introduction/what-is-openapi/",children:"OpenAPI"})]}),`
`,e.jsx(i.p,{children:"Still need help? Feel free reach out or open an issue on this repository!"})]})}function d(n={}){const{wrapper:i}={...s(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(t,{...n})}):t(n)}export{d as default,a as frontmatter};
