...
`,e.jsxs(n.li,{children:["(5.4) The ",e.jsx(n.code,{children:"Feature Embeddings"})," generation module can be configured to use either Ollama or an OpenAI-compatible API provider, such as a Gaia node, to generate vector embeddings with your preferred LLM embeddings model."]}),`
