...
Once you defined your API pipeline manifest file, you're ready to start using the `rag-api-pipeline run` command to execute different tasks of the RAG pipeline, 
